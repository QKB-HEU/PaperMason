...
4. Keep the PaperMeld Skill general. Put venue- or discipline-specific writing advice in a separate Skill.
...
preserve PaperMeld's transaction boundary: parse in a temporary directory,
